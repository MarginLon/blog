...
module.exports = {
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: 'MarginLon',
      description: 'For JavaScript Lovers',
    },
  },
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '前端',
        link: '/front-end/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
      ...
      },
      {
        ...
        items: [
          {
            text: 'Node.js',
            items: [{ text: 'Node.js', link: '/pages/677c60/' }],
          },
        ],
      },
      {
    ...
    bodyBgImg: [
      ...
      'https://fastly.jsdelivr.net/gh/MarginLon/cdn-repo@master/img/blog/bg4.jpg',
      'https://fastly.jsdelivr.net/gh/MarginLon/cdn-repo@master/img/blog/bg5.jpg',
      'https://fastly.jsdelivr.net/gh/MarginLon/cdn-repo@master/img/blog/bg6.png',
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          ...
          title: 'Gitee',
          link: 'https://gitee.com/MarginLon',
        },
        // {
